...
<main class="justify-between flex max-h-16 px-10 content-center mx-[-1em] text-center px-10 m-auto bg-gray-800 w-[100.475vw]">
    <h1 class="text-[2em] pt-2">ScoutClient 2025</h1>
    <span class="landscape flex justify-between content-center text-center px-10 w-[75vw]" bind:this={landscape}>
        {#key $page}
